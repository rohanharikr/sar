        ...
        <div className="flex flex-col justify-center items-center text-xl sm:text-2xl relative z-10 ">
            <div className="relative flex flex-col items-center max-w-xl w-full pt-8 pb-32 px-4 sm:px-8">
                ...
                <p className="tracking-widest uppercase mt-12 opacity-0" style={{ animation: "fade-in-up 0.35s ease 0.35s forwards" }}>
                    Sunday 12<sup className="lowercase">th</sup> July 2026
                </p>
                ...
                <div className="flex gap-4 sm:gap-8 uppercase text-sm tracking-widest mt-6 text-black/65 underline opacity-0" style={{ animation: "fade-in-up 0.35s ease 0.5s forwards" }}>
                    <a href="data:text/calendar;charset=utf-8,BEGIN%3AVCALENDAR%0AVERSION%3A2.0%0APRODID%3A-//Wedding//EN%0ABEGIN%3AVEVENT%0ADTSTART%3A20260712T062700Z%0ADTEND%3A20260712T064900Z%0ASUMMARY%3ARahul %26 Sandra's Wedding%0ALOCATION%3AHeartland Convention Center%2C Chalakudy%2C Kerala%0AEND%3AVEVENT%0AEND%3AVCALENDAR" download="rahul-sandra-wedding.ics">Apple Calendar</a>
                    <a href="https://calendar.google.com/calendar/render?action=TEMPLATE&text=Rahul+%26+Sandra%27s+Wedding&dates=20260712T062700Z/20260712T064900Z&location=Heartland+Convention+Center%2C+Chalakudy%2C+Kerala" target="_blank">Google Calendar</a>
                </div>
