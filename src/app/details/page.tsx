export default function Details() {
    return (
        <div className="flex flex-1 flex-col items-center justify-center text-xl sm:text-2xl py-16 sm:py-24 px-4 sm:px-0">
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-16 sm:gap-20 w-full max-w-5xl">
                ...
                <div className="flex flex-col items-center">
                    ...
                    <p className="text-center text-black/40 mb-2">~45 min drive to Chalakudy</p>
                    <p className="text-center leading-relaxed text-black/70">Nearest railway: Chalakudy station</p>
                    <p className="text-center text-black/40">~5 min from venue</p>
                    {/* <p className="text-center text-black/40 mt-3 italic">Cabs available via Uber &amp; Ola</p> */}
                </div>
                <div className="flex flex-col items-center">
                ...
                <div className="flex flex-col items-center">
                    ...
                    <p className="text-center leading-relaxed text-black/70 italic">Your presence is the greatest gift<br/>we could ask for</p>
                </div>
            </div>
