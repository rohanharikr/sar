                ...
                <div className="flex flex-col items-center w-full z-10">
                    ...
                    <div className="relative w-full max-w-xs">
                        ...
                        <div className="relative flex pb-4">
                            ...
                            <svg data-dash className="absolute left-[80px] sm:left-[95px] top-[52px] w-[80px] sm:w-[65px]" width="65" height="114" viewBox="0 0 65 114" preserveAspectRatio="none" fill="none">
